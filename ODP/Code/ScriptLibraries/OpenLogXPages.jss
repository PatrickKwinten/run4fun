/** TaskJam contains OpenLog application code developed by Julian Robichaux which Elguji Software, LLC has been specifically granted permission to use from Mr. Robichaux.
/**
	 * =======================================================
	 * <HEADER>
...
//var logDbPath = "openlog.nsf";
var logDbPath = facesContext.getApplication().getApplicationProperty("xsp.openlog.filepath", "30");
...
OpenLog = function(){
	...
	this.prototype.getLogDbPath = function (){
		/** 
		TaskJam specific code to get the logDbPath from the Control Panel
		*/
		if (applicationScope.containsKey("logDbPath")){
			logDbPath = applicationScope.logDbPath;
		} else {
			logDbPath = facesContext.getApplication().getApplicationProperty("xsp.openlog.filepath", "30");
		}
	}
	...
	*/
	this.prototype.logEvent = function(msg, severity, location, method, document){
		try {
			...
			this.logError("Error in OpenLog logEvent: " + e.getMessage, SEVERITY_HIGH, e, null, "OpenLogXPages", "logEvent", null, document);
		}
	}
